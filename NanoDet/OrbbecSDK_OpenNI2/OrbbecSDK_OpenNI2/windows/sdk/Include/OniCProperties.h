...
enum
{
	...
	ONI_STREAM_PROPERTY_BRIGHTNESS				= 104, // int
	ONI_STREAM_PROPERTY_SHARPNESS				= 105, // int
	ONI_STREAM_PROPERTY_AUTO_EXPOSURE_PRIORITY  = 106, // int
	ONI_STREAM_PROPERTY_SATURATION				= 107, // int
	ONI_STREAM_PROPERTY_CONTRAST				= 108, // int
	ONI_STREAM_PROPERTY_GAMMA					= 109, // int
	ONI_STREAM_PROPERTY_HUE						= 110, // int
};
