...
enum
{
	...
	OBEXTENSION_ID_COLOR_EXP = 19,
	OBEXTENSION_ID_COLOR_GAIN = 20,
...
enum
{
	...
	STREAM_PROPERTY_BRIGHTNESS				= 104, // int
	STREAM_PROPERTY_SHARPNESS				= 105, // int
	STREAM_PROPERTY_AUTO_EXPOSURE_PRIORITY  = 106, // int
	STREAM_PROPERTY_SATURATION				= 107, // int
	STREAM_PROPERTY_CONTRAST				= 108, // int
	STREAM_PROPERTY_GAMMA					= 109, // int
	STREAM_PROPERTY_HUE						= 110, // int
