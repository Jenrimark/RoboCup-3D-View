...
'''目标检测-图片'''
# python detect_main.py --demo image --config ./config/nanodet-m.yml --model tools/workspace/nanodet_m/model_best/model_best.pth --path  test1_gray.png
...
def parse_args():
    ...
    parser.add_argument('--model',default="tools/workspace/nanodet_m/model_best/model_best.pth", help="model/nanodet_m.pth")
    parser.add_argument('--path', default="test1_gray.png", help='path to images or video')
